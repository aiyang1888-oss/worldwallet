...
echo "📦 校验 dist/（唯一真源）…"
for f in wallet.html wallet.css wallet.core.js wallet.ui.js wallet.addr.js wallet.tx.js wallet.token.js wallet.swap.js wallet.runtime.js wallet.dom-bind.js wordlists.js; do
