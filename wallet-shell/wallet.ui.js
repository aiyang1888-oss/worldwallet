...
// 强刷或直接打开：清空 hash 深链后按钱包状态定首页（有钱包→#page-home，否则→#page-welcome）
...
// 具体落页与 #hash 由文件末尾 wwEnsureInitialHashRoute + wwApplyHashRoute（goTo 定义之后）统一处理
...
// ── 全页刷新时由上方 boot + wwEnsureInitialHashRoute 统一落到首页/欢迎页，不再用 session 恢复上次 tab ──
